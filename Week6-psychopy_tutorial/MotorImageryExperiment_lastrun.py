...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    walcome_screen = data.Routine(
        name='walcome_screen',
        components=[textwelcomescreen, cortex_rec],
    )
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[cross_on_screen, arrow, rest_cue, stim_image, eeg_marker],
        )
        ...
        while continueRoutine and routineTimer.getTime() < 9.0:
            ...
            if eeg_marker.status == NOT_STARTED and t >= 2.5-frameTolerance:
                # keep track of start time/frame for later
                ...
                cortex_obj.inject_marker(value=str('1'), label=arrow_direct, delta_time=delta_time)
            ...
            if eeg_marker.status == STARTED:
                ...
                if tThisFlipGlobal > eeg_marker.tStartRefresh + 1-frameTolerance:
                    ...
                    eeg_marker.tStopRefresh = tThisFlipGlobal  # on global time
